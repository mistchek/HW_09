...
class PrintedBook(Book):
    def __init__(self, name, author, year, pages, condition):
    ...
    def __str__(self):
        base = super().__str__()
        return (
            f"{base}, Кол-во страниц: {self.__pages}, "
            f"Cостояние: {self.__condition}"
        )


class EBook(Book):
    def __init__(self, name, author, year, file_size, file_format):
        super().__init__(name, author, year)
